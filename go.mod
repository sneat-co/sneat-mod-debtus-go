...
require (
	...
	github.com/bots-go-framework/bots-fw-telegram-models v0.0.8
	github.com/bots-go-framework/bots-go-core v0.0.1
	github.com/bots-go-framework/bots-host-gae v0.4.1
	github.com/bots-go-framework/dalgo4botsfw v0.0.12
	...
	github.com/sneat-co/debtstracker-translations v0.0.5
	github.com/strongo/app v0.5.5
	github.com/strongo/app-host-gae v0.1.11
