	...
	if len(_bots.ByCode) == 0 || (!_bots.HasRouter && router != nil) {
		...
		case strongo.EnvProduction:
			_bots = bots.NewBotSettingsBy(router,
				// Production bots
				telegram.NewTelegramBot(strongo.EnvProduction, bot.ProfileCollectus, "CollectusBot", "458860316:AAFk_hOXK5vFWu43jp4apWgQjmHHv87CU9E", "", "", strongo.LocaleEnUS),
				...
				telegram.NewTelegramBot(strongo.EnvProduction, bot.ProfileDebtus, "DebtsTrackerPLbot", "254844727:AAG3a_1wgSuu77gWmKrcnUy0KN7Yrt0MhO8", "", "", strongo.LocalePlPl),
				telegram.NewTelegramBot(strongo.EnvProduction, bot.ProfileDebtus, "DebtsTrackerPtBot", "236826743:AAGx0uDsCO0RZap84IO7dzVSszfA_0HE1m4", "", "", strongo.LocalePtBr),
				telegram.NewTelegramBot(strongo.EnvProduction, bot.ProfileDebtus, "DebtsTrackerEsBot", "189365214:AAGnXfb8qqUou__-X5foSGSGfgOkXDm9wV4", "", "", strongo.LocalePtBr),
			)
		...
		case strongo.EnvStaging:
			_bots = bots.NewBotSettingsBy(router,
				// Staging bots
				telegram.NewTelegramBot(strongo.EnvStaging, bot.ProfileDebtus, "DebtsTrackerSt1Bot", "254651741:AAFY_jdNxZHZ5OEIu4VEr5tdcSPSAYnLLWE", "", "", strongo.LocaleEnUS),
			)
		case strongo.EnvLocal:
			_bots = bots.NewBotSettingsBy(router,
				// Staging bots
				telegram.NewTelegramBot(strongo.EnvLocal, bot.ProfileDebtus, "DebtsTrackerLocalBot", "334671898:AAG38EvZhGb3FTCttyCoSwtmQGFeZ20SqdQ", "", "", strongo.LocaleEnUS),
				telegram.NewTelegramBot(strongo.EnvLocal, bot.ProfileSplitus, "SplitusLocalBot", "447286300:AAF6qaS1rp7zfdB3h56lkzrReAHpEWKKYLY", "", "", strongo.LocaleEnUS),
				telegram.NewTelegramBot(strongo.EnvLocal, bot.ProfileCollectus, "CollectusLocalBot", "471286497:AAF1m-0jqQeJyXSH1gKMRSeX87Xr_HnIiII", "", "", strongo.LocaleEnUS),
			)
		default:
