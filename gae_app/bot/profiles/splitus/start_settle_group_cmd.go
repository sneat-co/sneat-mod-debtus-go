...
func settleGroupCounterpartyConfirmedAction(whc botsfw.WebhookContext, group models.Group, memberID string, currency money.Currency) (m botsfw.MessageFromBot, err error) {
