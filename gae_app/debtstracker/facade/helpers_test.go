...
func SetupMocks(c context.Context) dalmocks.MockDB {
	...
	dal.Contact.SaveContact(c, models.Contact{IntegerID: db.IntegerID{ID: 6}, ContactEntity: &models.ContactEntity{
		Status: models.STATUS_ACTIVE, UserID: 1, CounterpartyUserID: 0, ContactDetails: models.ContactDetails{Nickname: "Den"}}})

	dal.Contact.SaveContact(c, models.Contact{IntegerID: db.IntegerID{ID: 8}, ContactEntity: &models.ContactEntity{
		Status: models.STATUS_ACTIVE, UserID: 3, CounterpartyUserID: 1, ContactDetails: models.ContactDetails{Nickname: "Eagle"}}})
	dal.Contact.SaveContact(c, models.Contact{IntegerID: db.IntegerID{ID: 10}, ContactEntity: &models.ContactEntity{
		Status: models.STATUS_ACTIVE, UserID: 5, CounterpartyUserID: 0, ContactDetails: models.ContactDetails{Nickname: "Ford"}}})
	dal.Contact.SaveContact(c, models.Contact{IntegerID: db.IntegerID{ID: 12}, ContactEntity: &models.ContactEntity{
